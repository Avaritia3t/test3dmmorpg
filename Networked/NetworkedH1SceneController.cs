...
/// <summary>
/// Scene setup for H1 (networked): SwitchMap, spawn point for all connections, optional server init of INetworkedAttackHandlerPool.
/// Required: one instance in H1 scene. No component requirements; uses MapService and optional INetworkedAttackHandlerPool from locator.
/// </summary>
[DefaultExecutionOrder(-500)]
public class NetworkedH1SceneController : MonoBehaviour
{
    ...
    {
        Debug.Log("Initializing H1 Scene (Networked)...");
        ...
        if (NetworkServer.active && AttackHandlerPool != null)
        {
            ...
            Debug.Log("NetworkedAttackHandlerPool initialized for H1 Scene (server).");
        }
